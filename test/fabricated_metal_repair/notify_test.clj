(ns fabricated-metal-repair.notify-test
  ...
  Twilio transport to stub-and-test -- see `fabricated-metal-repair.
  notify` ns docstring."
...
(deftest dispatch-safety-concern-notice-fans-out-to-every-contact-both-channels
  (let [n (notify/mock-notifier)
        contacts [{:name "Koji" :email "koji@example.com" :phone "+819000000031"}
                  {:name "Aiko" :email "aiko@example.com" :phone "+819000000032"}]
