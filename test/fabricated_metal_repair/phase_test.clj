(ns fabricated-metal-repair.phase-test
  ...
  `fabricated-metal-repair.phase` ns docstring 'Actuation' section, and
  ...
  installation-operation` (which is never auto-eligible), matching the
  shape `cloud-itonami-isic-3314`/`cloud-itonami-isic-3319` use."
