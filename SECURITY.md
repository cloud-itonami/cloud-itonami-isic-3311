...
This project handles fabricated-metal-product-repair-shop coordination
data (equipment/work-order records, safety-concern flags, supply-order
...
- If a real notification transport is ever added, keep its credentials
  ...
  `fabricated-metal-repair.notify/Notifier` via a portable (cljs/nbb)
