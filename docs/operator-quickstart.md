# Operator Quickstart — Repair of Fabricated Metal Products

Shortest path from clone to a verified local dry-run for **ISIC 3311** (`cloud-itonami-isic-3311`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3311.git
cd cloud-itonami-isic-3311
```
...
- Blueprint governor key: `fabricated-metal-repair-governor`
- Likely source path: `fabricated_metal_repair.governor.cljc`
