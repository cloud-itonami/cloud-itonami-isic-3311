# Business Model: Repair of Fabricated Metal Products
...
## Classification
- Repository: `cloud-itonami-isic-3311` ([github.com/cloud-itonami/cloud-itonami-isic-3311](https://github.com/cloud-itonami/cloud-itonami-isic-3311))
- ISIC Rev.5: `3311` — Repair of Fabricated Metal Products
- Domain: `:manufacturing/fabricated-metal-repair`
- Social impact: :worker-safety :repair-access :circular-economy-repair-over-replace
- Actor: `:fabricated-metal-repair-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :manufacturing/fabricated-metal-repair — who wants
...
One managed tenant (:manufacturing/fabricated-metal-repair):
...
- Do not bypass the `:fabricated-metal-repair-governor` for production decisions.
