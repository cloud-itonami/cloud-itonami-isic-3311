(ns fabricated-metal-repair.operation
  "OperationActor -- one fabricated-metal-repair-shop coordination
  ...
  `fabricated-metal-repair.phase`/`fabricated-metal-repair.governor` ns
  ...
  auto-commit at phase 3 -- see `fabricated-metal-repair.phase` ns
  docstring.

  Every committed record carries `:effect :propose` (see `fabricated-
  metal-repair.governor` ns docstring) -- the `:commit` node writes a
  ...
  `fabricated-metal-repair.notify`) to the equipment/work-order's
  ...
  (:require [langgraph.graph :as g]
            ...
            [fabricated-metal-repair.advisor :as advisor]
            [fabricated-metal-repair.governor :as governor]
            [fabricated-metal-repair.notify :as notify]
...
(defn build
  ...
  `fabricated-metal-repair.store/Store`).
  opts:
    :advisor      -- a `fabricated-metal-repair.advisor/Advisor` (default: mock-advisor)
    :notifier     -- a `fabricated-metal-repair.notify/Notifier` (default: mock-notifier)
