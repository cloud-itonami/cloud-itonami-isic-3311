(ns fabricated-metal-repair.notify
  ...
  the fabricated-metal-repair-domain analog of `installation.notify`/
  `demolition.notify`/`electrical-equipment-repair.notify`/`other-
  equipment-repair.notify`.
  ...
  escalates to a human first (see `fabricated-metal-repair.phase`/
  `fabricated-metal-repair.governor` ns docstrings), so by the time
  `fabricated-metal-repair.operation`'s `:commit` node calls this, a
...
(defn dispatch-safety-concern-notice!
  ...
  every other responsible party of a flagged structural-integrity/weld-
  repair-quality/pressure-test concern."
